...
class TestCatalogueConverter(TestCase):
    ...
    def test_to_python(self):
        self.assertEqual(
            self.converter.to_python("miscellaneousitem"), ContentType.objects.get_for_model(MiscellaneousItem)
        )
    ...
    def test_to_url(self):
        ...
        self.assertEqual(
            self.converter.to_url(ContentType.objects.get_for_model(MiscellaneousItem)), "miscellaneousitem"
        )
