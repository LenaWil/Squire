    ...
    def test_serializer_achievement_claimants_all(self):
        ...
        self.assertDictEqual(
            serializer.data,
            {
                ...
                "claimants": ClaimantSerializer(
                    Claimant.objects.filter(achievement__id=self.achievement.id).order_by("-date_unlocked"), many=True
                ).data,
        ...
        self.assertDictEqual(
            serializer.data,
            {
                ...
                "achievements": AchievementSerializer(
                    ...
                    many=True,
                    context={"user_id": 1, "obtain_claimants": False},
                ).data,
            },
        )
